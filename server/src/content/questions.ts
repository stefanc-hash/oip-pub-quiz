 ...
 * IDs use prefix q-a (Serbia) and q-b (OIP) so Serbia sorts first alphabetically.
 * seedAll() upserts on every boot; pruneStale() removes any IDs not listed here.
 */
